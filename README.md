# avito-tech-task
JSON Parsing task Avito

### Результат
- Кэширование >1 часa не живет
- Обработка потери интернета/появления интернета
<p align="center">
  <img src="demo1.gif" width="375" height="812">
</p>

- Кэширование на время < 1 часа работает нормально
<p align="center">
  <img src="demo2.gif" width="375" height="812">
</p>
